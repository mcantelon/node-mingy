...
// if on last syntax lexeme, amalgamate subsequent submitted lexemes to test if syntax lexeme is a wildcard
if (syntax_lexemes[last_syntax_lexeme_index][(syntax_lexemes[last_syntax_lexeme_index].length - 2)] == '*') {
  console.log('GA:' + syntax_lexemes[last_syntax_lexeme_index])

/*
var temp_index = index
      while(index < input_lexemes.length) {
console.log(input_lexemes[index])
        input_lexemes[temp_index] += ' ' + input_lexemes[index]
        index++
      }
console.log('I:' + index)
*/
