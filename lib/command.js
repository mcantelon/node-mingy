      ...
      for(var index in this.syntax) {
        ...
        //if (syntax_lexemes.length == lexemes.length) {
          ...
          if (valid) {
            ...
            var second_to_last_char = syntax_lexemes[last_syntax_lexeme_index].length - 2
            if (syntax_lexemes[last_syntax_lexeme_index][second_to_last_char] == '*') {

              var index2 = last_syntax_lexeme_index + 1
              while(index2 < lexemes.length) {
                lexemes[last_syntax_lexeme_index] += ' ' + lexemes[index2]
                index2++
              }
            }
