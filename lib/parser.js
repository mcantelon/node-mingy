...
exports.Parser.prototype = {
  ...
  parse: function(input, callback, stream, request) {

    input = this.cleanInput(input)
    var lexemes = input.split(' ')
    return this.parseLexemes(lexemes, callback, stream, request)
  },
  ...
  parseLexemes: function(lexemes, callback, stream, request) {
